...
<div id="wrapper">
	...
	<i class="ace-icon fa fa-plus"></i> <a href="tambahdatakucing.php" style="text-decoration:none"><font color="white">Tambah Data</a></font>
</button>
</div>
<br>
			<div class="container">
					...
					<div class="col-lg-10">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
								<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Data Kucing </h3></div>
		...
		<tr>
			...
			<td><?php echo $pecah['no_sertifikat']; ?></td>
			<td><?php echo $pecah['nama_kucing']; ?></td>
			<td><?php echo $pecah['jenis_kucing']; ?></td>
			<td><?php echo $pecah['umur_kucing']; ?></td>
			<td>
				<a href="hapusdata.php?id=<?php echo $pecah['id_kucing']; ?>" class="btn-danger btn">Hapus</a>
				<a href="ubahdatakucing.php?id=<?php echo $pecah['id_kucing']; ?>" class="btn btn-warning">Ubah</a>
			</td>
		</tr>
		<?php
			$nomor++;
