    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            if (isset($_POST['submit'])) {
                $tanggalawal = $_POST['tanggalawal'] . " 00:00:00";
                $tanggalakhir = $_POST['tanggalakhir'] . " 00:00:00";
                $link = "cetak.php?tglawal={$tanggalawal}&tglakhir={$tanggalakhir}";
                $sql = "SELECT * FROM transaksi WHERE kd_transaksi";
            }
            ?>
                    ...
                    <div class="col-lg-12">
                        <button class="btn btn-primary" type="submit" name="submit">Cari</button>
                            ...
                            <!-- <a href="<?= $link ?>" target="_blank">
                                <button class="btn btn-info no-print">Print</button>
                            </a> -->
		...
		?>
		<?php 
			$ambil = $koneksi->query("SELECT * FROM transaksi WHERE kd_transaksi ORDER BY kd_transaksi DESC ");
		...
		<tr>
			...
			<td>
                ...
                <a href="detail.php?id=<?php echo $pecah['kd_transaksi']; ?>" class="btn btn-warning">Detail</a>
			</td>
		</tr>
		<?php
			$nomor++;
