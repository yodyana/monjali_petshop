...
<button class="btn btn-primary pull-right">
	<i class="ace-icon fa fa-plus"></i> <a href="tambahdata.php" style="text-decoration:none"><font color="white">Tambah Data</a></font>
</button>
<table class="table table-bordered">
		...
		?>
		<?php 
			$ambil = $koneksi->query("SELECT * FROM jenis WHERE kd_jenis ORDER BY kd_jenis DESC ");
		...
		<tr>
			...
			<td>
                <div class="samping">
				<a href="hapuspelayanan.php?id=<?php echo $pecah['kd_jenis']; ?>" onclick="return confirm('Anda yakin ingin menghapus data ?');" class="btn-danger btn">Hapus</a>
