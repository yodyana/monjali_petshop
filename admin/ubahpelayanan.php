...
if (empty($_SESSION['email']) and empty($_SESSION['password'])) {
    ...
    $queryPelayanan = query(
        "SELECT * FROM  jenis WHERE kd_jenis = '$idPelayanan'"
    )[0];
    ?>
...
<div class="page-content"><br>
        ...
        <div class="row">
									...
									<center><h3 class="panel-title"></span><font size="5" face="Times new roman"> Ubah Data Pelayanan </h3></center></font>
									</div>
                 ...
                 'keterangan'
                                     ...
                                     <?php if (isset($_POST['submit'])) {
                                         $koneksi->query("UPDATE jenis SET kode_kategori='$_POST[kategori]', nama='$_POST[nama]',
                                        harga='$_POST[harga]',keterangan='$_POST[keterangan]' WHERE kd_jenis='$_GET[id]'");
