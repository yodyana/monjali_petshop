					...
					<div class="col-lg-5">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Ubah Data Kucing </h3>
									</div>
									<div class="panel-body">
									<form name="ubahdatakucing" id="ubahdata" method="POST" role="form" class="lead">
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-12">
												<div class="form-group">
													<label>No Sertifikat</label>
													<input type="text" name="no_sertifikat" class="form-control input-md" value="<?php echo $pecah['no_sertifikat']; ?>">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-12">
												<div class="form-group">
		                                            ...
		                                            <input type="text" class="form-control" name="nama_kucing" value="<?php echo $pecah['nama_kucing']; ?>" onkeypress='return harusHuruf(event)'>
                                                <script>
                                        ...
                                        <div class="row">
											<div class="col-xs-6 col-sm-6 col-md-12">
												<div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="jenis_kucing" value="<?php echo $pecah['jenis_kucing']; ?>">
                                                </div>
											</div>
										</div>
                                        <div class="row">
											<div class="col-xs-6 col-sm-6 col-md-12">
												<div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="umur_kucing" value="<?php echo $pecah['umur_kucing']; ?>">
                                                </div>
											</div>
										</div>
                                    ...
                                    <?php
                                        ...
                                        { 
                                            $koneksi->query("UPDATE biodatakucing SET nama_kucing='$_POST[nama_kucing]',jenis_kucing='$_POST[jenis_kucing]',umur_kucing='$_POST[umur_kucing]' WHERE id_kucing='$_GET[id]'");

                                            echo "<script>alert('Data kucing telah diubah');</script>";
                                            echo "<script>location='home.php?halaman=kucing';</script>";
                                        }
                                    ?>
								</div>
							</div>				
