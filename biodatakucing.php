						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s"></div>
							...
							<div class="panel-heading">
									...
									<div class="btn btn-skin btn-block btn-lg">
										...
										<a href="home.php" class="btn btn-skin btn-lg">Sudah Daftar? Klik Disini!</a>		
									</div><br>
										...
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-12">
												<div class="form-group">
													...
													<input type="text" name="nama_kucing" onkeypress='return harusHuruf(event)' placeholder="nama_kucing" id="nama_kucing" class="form-control input-md" required data-error="">
													<script>
										...
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-12">
												<div class="form-group">
													...
													<input type="text" name="jenis_kucing" onkeypress='return harusHuruf(event)' placeholder="jenis_kucing" id="jenis_kucing" class="form-control input-md" required data-error="">
													<script>
													function harusHuruf(evt){
															var charCode = (evt.which) ? evt.which : event.keyCode
															if ((charCode < 65 || charCode > 90)&&(charCode < 97 || charCode > 122)&&charCode>32)
